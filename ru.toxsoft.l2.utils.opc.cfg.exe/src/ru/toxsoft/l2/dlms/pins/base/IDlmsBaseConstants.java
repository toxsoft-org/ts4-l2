package ru.toxsoft.l2.dlms.pins.base;

/**
 * TODO - был перенесён из pins.base. Сделать pins.base актуальным и убрать отсюда
 *
 * @author max
 */
...
public interface IDlmsBaseConstants {
  ...
  /**
   * Имя параметра - минимальный интервал обновления синхронного данного (для сервера) в мс.
   */
  String MIN_SYNCH_INTERVAL = "min.synch.interval";

  /**
   * Имя параметра - максимально допустимый интервал обновления синхронного данного (для сервера) в мс.
   */
  String MAX_SYNCH_INTERVAL = "max.synch.interval";
   ...
   */
  String SRC_TAG_ID = "tag.id";

  /**
   * Имя параметра - идентификатор специального устройства
   */
  String SPEC_DEVICE_ID = "device.id";
   ...
   */
  String SRC_OBJ_DATA = "SRC.OBJ.ATTR";
