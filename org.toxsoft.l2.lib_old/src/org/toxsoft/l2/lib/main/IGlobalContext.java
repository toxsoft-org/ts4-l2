...
public interface IGlobalContext {
   ...
   * <p>
   * <p>
   * В указанном наборе содержиться все параметры из перечисления {@link IGlobalOps}, а также все дополнительные
   ...
   * и низший приоритет имеют значения по умолчанию из набора {@link IGlobalOps}.
   *
   ...
   */
  // IApp appApi();
  IHalErrorProcessor errorProcessor();
