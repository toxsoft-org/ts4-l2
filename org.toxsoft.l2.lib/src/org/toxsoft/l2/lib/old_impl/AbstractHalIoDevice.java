package org.toxsoft.l2.lib.old_impl;

import static org.toxsoft.l2.lib.old_impl.IHalHardConstants.*;
...
public abstract class AbstractHalIoDevice
  ...
  record ApparatError ( String aApparatId, String aErrorId, IOptionSet aParams, Exception aException ) {
  }

  interface IHalErrorProcessor {
