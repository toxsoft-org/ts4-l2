package org.toxsoft.l2.lib.hal.impl;

import static org.toxsoft.l2.lib.hal.IHalHardConstants.*;
import static org.toxsoft.l2.lib.hal.impl.IL2Resources.*;
...
public class HalImpl
  ...
  private IDevicesProducer createDevicesProducer( IUnitConfig aCfg ) {
    ...
    try {
      ...
      producer.setHalErrorProcessor( globalContext.errorProcessor() );
