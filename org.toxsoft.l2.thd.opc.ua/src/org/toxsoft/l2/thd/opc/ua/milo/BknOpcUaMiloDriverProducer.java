...
/**
 * Создает коллекцию драйверов opc ua для Байконура
 *
 * @author dima
 */
public class BknOpcUaMiloDriverProducer
   ...
   * Пустой конструктор.
   */
  public BknOpcUaMiloDriverProducer() {
  }
  ...
  private OpcUaMiloDriver createOpcUaMiloDriver( IUnitConfig aConfig ) {
    ...
    if( bridges.arrayLength() > 0 ) {
      ...
      return new BknOpcUaMiloDriver( driverId, driverDescr, errorProcessor, bridgeConfig );
    }
